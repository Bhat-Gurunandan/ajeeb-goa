...
pandoc -f gfm -t html --template epub/template.xhtml markdown/chapter13.md      -o epub/ebook/OEBPS/chapter13.xhtml
pandoc -f gfm -t html --template epub/template.xhtml markdown/bibliography.md   -o epub/ebook/OEBPS/bibliography.xhtml
cd epub/ebook
rm -rf ebook.zip
rm -rf ebook.epub
...
cd ..
epubcheck Ajeeb_Goa_Gajab_Politics.epub
